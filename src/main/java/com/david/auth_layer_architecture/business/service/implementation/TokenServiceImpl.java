...
public class TokenServiceImpl implements ITokenService {
    ...
    @Override
    public SignInResponse generateAuthTokens(Credential credential) {
        ...
        return new SignInResponse(tokenToAccessApp, refreshTokenToAccessApp);
    }

    @Override
    public SignInResponse generateVerifyAccountTokens(Credential credential) {
        ...
        return new SignInResponse(accessTokenToVerifyAccount, refreshTokenToVerifyAccount);
